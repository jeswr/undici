...
const kAddressBlockedError = Symbol.for('undici.error.UND_ERR_ADDRESS_BLOCKED')
class AddressBlockedError extends UndiciError {
  constructor (message, { address, family, hostname } = {}) {
    super(message)
    this.name = 'AddressBlockedError'
    this.message = message || 'Address blocked'
    this.code = 'UND_ERR_ADDRESS_BLOCKED'
  ...
  static [Symbol.hasInstance] (instance) {
    return instance && instance[kAddressBlockedError] === true
  }

  get [kAddressBlockedError] () {
    return true
  }
}
