...
function findEntry (key, entries, now) {
  return entries.find((entry) => (
    ...
    // For body-significant methods (QUERY) the request-body hash is part of the
    // key (RFC 10008 Section 2.7); undefined === undefined for body-blind methods.
    entry.requestBodyHash === key.requestBodyHash &&
